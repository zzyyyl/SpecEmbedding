...
| 系列 | 协议与用途 | 来源 |
| --- | --- | --- |
| v1.5 全量迁移 | 原矩阵已按用户要求中断，已有部分全量结果；转为单 baseline 优化，论文更新暂停 | [执行计划](../docs/paper-change-plans/2026-09-07-MassSpecGym全量重训.md)、[数据泄露与准确率排查报告](../docs/massspecgym_data_leakage_report_zh.md)、[身份转换修复](massspecgym_v15_inchi_fix.md) |
