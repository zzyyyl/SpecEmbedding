...
| 系列 | 协议与用途 | 来源 |
| --- | --- | --- |
| v1.5 全量迁移 | 原队列运行中，已有部分全量结果；旧候选表示偏差影响解释，论文更新待确认 | [执行计划](../docs/paper-change-plans/2026-09-07-MassSpecGym全量重训.md)、[准确率排查](massspecgym_v15_regression_audit.md)、[身份转换修复](massspecgym_v15_inchi_fix.md) |
