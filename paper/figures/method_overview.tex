...
\newcommand{\methodoverview}[1]{%
  ...
  \begin{tikzpicture}[
    ...
    % Stage 2: score the official candidate library and retain a reusable list.
    ...
    \node[moSmall, text width=2.30cm] (protocol) at (10.55,3.38)
      {\molabel{Official mass/formula\\candidates}
      {官方质量/分子式\\候选}};
    ...
    % Stage 3: matched pointwise/set-aware variants and a shared residual path.
    ...
    \node[moChoice, text width=1.70cm] (setaware) at (5.62,1.16)
      {\textbf{Set-aware}\\\molabel{self-attention}{集合自注意力}};
